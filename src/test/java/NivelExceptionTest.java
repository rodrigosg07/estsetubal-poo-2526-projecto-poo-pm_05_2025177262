...
public class NivelExceptionTest {
    ...
    void testeDeveLancarExcecaoQuandoLinhasInvalidas() {
        ...
        NivelException nivelException = assertThrows(NivelException.class, () -> new Nivel(1,10,0,4));

        assertEquals("Dimensões de tabuleiro inválidas", nivelException.getMessage());

        // Testando com linhas negativas
        NivelException nivelException1 = assertThrows(NivelException.class, () -> new Nivel(1,10,-4,4));
    ...
    void testeDeveLancarExcecaoQuandoColunasInvalidas() {
        ...
        NivelException nivelException = assertThrows(NivelException.class, () -> new Nivel(1,10,4,0));
    ...
    void testeDeveLancarExcecaoQuandoTotalDeCartasForImpar() {
        NivelException nivelException = assertThrows(NivelException.class, () -> new Nivel(1,10,3,3));
    ...
    void testeDeveLancarExcecaoQuandoMaxTentativasInvalido() {
        ...
        NivelException nivelException = assertThrows(NivelException.class, () -> new Nivel(1,0,4,4));

        assertEquals("O maximo de tentativas deve ser positivo", nivelException.getMessage());

        //Testar a tentativas negativas
        NivelException nivelException2 = assertThrows(NivelException.class, () -> new Nivel(1,-1,4,4));
