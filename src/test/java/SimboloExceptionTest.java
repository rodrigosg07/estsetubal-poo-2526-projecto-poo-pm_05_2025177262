...
public class SimboloExceptionTest {
    ...
    void TesteDeveLancatExcecaoQuandoSimboloForNull() {
        SimboloException simboloException = assertThrows(SimboloException.class, () -> new CartaNormal(1,null));
    ...
    void TesteDeveLancatExcecaoQuandoSimboloForVazio() {
        SimboloException simboloException2 = assertThrows(SimboloException.class, () -> new CartaNormal(1,""));
