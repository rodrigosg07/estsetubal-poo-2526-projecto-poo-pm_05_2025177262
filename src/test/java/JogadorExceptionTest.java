...
public class JogadorExceptionTest {
    ...
    void TesteDeveLancatExcecaoSeNomeDeJogadorForNull() {
        JogadorException jogadorException = assertThrows(JogadorException.class, () -> {
            new Jogador(null, 1, 1);
        });
    ...
    void TesteDeveLancatExcecaoSePontuacaoNegativa() {
        JogadorException jogadorException2 = assertThrows(JogadorException.class, () -> {
            new Jogador("a", -1, 1);
        });
    ...
    void TesteDeveLancatExcecaoSeTentativasNegativas() {
        JogadorException jogadorException3 = assertThrows(JogadorException.class, () -> {
            new Jogador("a", 1, -1);
        });
